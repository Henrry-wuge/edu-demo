...
--
-- Table structure for table `edu_file`
--

DROP TABLE IF EXISTS `edu_file`;
...
--
-- Dumping data for table `edu_file`
--

LOCK TABLES `edu_file` WRITE;
...
-- Dump completed on 2020-04-21 14:20:43
