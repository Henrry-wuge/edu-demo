...
CREATE TABLE `edu_course` (
  ...
  `course_introduce` varchar(45) NOT NULL,
  `price` int(11) NOT NULL,
  `validity_start` datetime NOT NULL,
  `validity_over` datetime NOT NULL,
  `review_start` datetime NOT NULL,
  `review_over` datetime NOT NULL,
  `featured` int(11) DEFAULT '0',
  `popular` int(11) DEFAULT '0',
  `qing_niao` int(11) DEFAULT '0',
...
-- Dump completed on 2020-04-21 14:20:44
